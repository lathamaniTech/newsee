...
class RbIHLandCrop extends StatefulWidget {
  const RbIHLandCrop({super.key});

  @override
  RbIHLandCropState createState() => RbIHLandCropState();
}

class RbIHLandCropState extends State<RbIHLandCrop>
                          ...
                          onPressed: () {
                            ...
                            Future.delayed(
                              ...
                              () async {
                                ...
                                setState(() {
                                  status =
                                      'loaded'; // Update status after loading
                                });
                                bottomSheetSetState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Land & Owner Details')),
      body:
          ownerData == null || ownerData!.isEmpty
              ? const Center(
                child: Text('No data available. Please enter details.'),
              )
              : ListView(
                ...
                children: [
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildDetailRow(
                              'Father\'s Name:',
                              ownerDetail['owner']['fathername'] ?? 'N/A',
                            ),
                            _buildDetailRow(
                              'Address:',
                              ownerDetail['owner']['address'] ?? 'N/A',
                            ),
                            _buildDetailRow(
                              'Hissa:',
                              ownerDetail['owner']['hissa'] ?? 'N/A',
                            ),
                            _buildDetailRow(
                              'Heir Percentage Share:',
                              '${ownerDetail['owner']['heirpcshr']}%' ?? 'N/A',
                            ),
                            const SizedBox(height: 16.0),
                            const Text(
                              'Land Parcel Details:',
                            ...
                            _buildDetailRow(
                              'Khasra No:',
                              ownerDetail['landParcel']['khasrano'] ?? 'N/A',
                            ),
                            _buildDetailRow(
                              'Total Area:',
                              '${ownerDetail['landParcel']['totarea']} Acre' ??
                                  'N/A',
                            ),
                            _buildDetailRow(
                              'Village Code:',
                              ownerDetail['landParcel']['villagecode'] ?? 'N/A',
                            ),
                            _buildDetailRow(
                              'ULPIN:',
                              ownerDetail['landParcel']['ulpin'] ?? 'N/A',
                            ),
                          ],
                        ),
                      ),
                  ...
                  const SizedBox(height: 12.0),
                  if (mortgageDetailsList != null &&
                      mortgageDetailsList!.isNotEmpty)
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              _buildDetailRow(
                                'Amount:',
                                convertRuppee(mortgage['mortgage_amount']) ??
                                    'N/A',
                              ),
                              _buildDetailRow(
                                'Bank:',
                  ...
                  const SizedBox(height: 12.0),
                  if (cropYieldDetailsList != null &&
                      cropYieldDetailsList!.isNotEmpty)
