  ...
  routes: <RouteBase>[
    ...
    GoRoute(
      ...
      builder: (context, state) {
        ...
        final custId =
            (state.extra as Map<String, dynamic>?)?['custId'] as String;
        final isCompleted =
            (state.extra as Map<String, dynamic>?)?['isCompleted'] as bool;
        return BlocProvider(
          create:
              (_) =>
                  LandHoldingBloc()..add(
    ...
    GoRoute(
      ...
      builder: (context, state) {
        final proposalNumber =
            (state.extra as Map<String, dynamic>?)?['proposal'] as String;
        final isCompleted =
            (state.extra as Map<String, dynamic>?)?['isCompleted'] as bool;
        return BlocProvider(
          create:
